 ...
 */
#if 0
#define XTAL_FREQ                                   26000000        /* modified from 32MHz */
#define FREQ_STEP                                   49.591064453125 /* modified from 61.03515625 */
#endif
/*!
...
typedef struct sSX1276LR
{
    ...
    uint8_t RegTestReserved27[0x30 - 0x27];         // 0x27-0x2f    /* modified by chuanpengl */
    uint8_t RegTestReserved30;                      // 0x30         /* modified by chuanpengl */
 ...
 * @return  none
 */
extern void SX1276LoRaSetPreambleLength( uint16_t a_u16Value );
 ...
 */
extern uint16_t SX1276LoRaGetPreambleLength( void );
