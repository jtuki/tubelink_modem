 ...
 */
extern inline uint8_t SX1276ReadDio0( void );
 ...
 * \retval status Current hardware pin status [1, 0]
 */
extern  inline uint8_t SX1276ReadDio1( void );
 ...
 * \retval status Current hardware pin status [1, 0]
 */
extern inline uint8_t SX1276ReadDio2( void );
 ...
 * \retval status Current hardware pin status [1, 0]
 */
extern inline uint8_t SX1276ReadDio3( void );
 ...
 * \retval status Current hardware pin status [1, 0]
 */
extern inline uint8_t SX1276ReadDio4( void );
 ...
 * \retval status Current hardware pin status [1, 0]
 */
extern inline uint8_t SX1276ReadDio5( void );

/*!
 * \brief Gets the SX1276 RxTx hardware pin status
 *
 * \retval status Current hardware pin status [1, 0]
 */
extern inline uint8_t SX1276ReadRxTx( void );
 ...
 */
extern inline void SX1276WriteRxTx( uint8_t txEnable );



extern void sx1276_EnDio2Int(uint8_t en);
